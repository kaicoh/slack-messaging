...
/// [Multi select menu from static options](https://docs.slack.dev/reference/block-kit/block-elements/multi-select-menu-element#static_multi_select)
/// representation
///
/// # Example
///
...
#[builder(validate = "validate_static_options")]
...
fn validate_static_options(
    builder: &MultiSelectMenuStaticOptionsBuilder,
